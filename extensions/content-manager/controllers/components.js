...
module.exports = {
  ...
  async findComponentConfiguration(ctx) {
    ...
    const componentsConfigurations =
      await componentService.findComponentsConfigurations(component);
  ...
  async updateComponentConfiguration(ctx) {
    ...
    try {
      ...
      console.log("in components", null, {
    ...
    const newConfiguration = await componentService.updateConfiguration(
      component,
      input
    );
